...
<!--SCOREBOARD:START-->
_Last run **2026-09-17** · data source: **real SPY daily (Yahoo)** · cost: 1&nbsp;bp per turnover · benchmark: buy &amp; hold SPY._

| # | Strategy | Author | Locked | OOS window | OOS return | Sharpe | Max DD | vs B&H | Status |
|--:|---|---|:--:|:--:|--:|--:|--:|--:|:--|
| 1 | Buy & Hold | Martingale | `2022-01-01` | 1180d from 2022-01-03 | +69.7% | 0.74 | -24.5% | — | _benchmark_ |
| 2 | Time-Series Momentum (60d) | Martingale | `2022-01-01` | 1180d from 2022-01-03 | +18.8% | 0.30 | -27.5% | -0.44 | trailed benchmark |
| 3 | SMA Crossover (20/100) | Martingale | `2022-01-01` | 1180d from 2022-01-03 | +2.3% | 0.12 | -32.9% | -0.62 | trailed benchmark |
| 4 | Mean Reversion (1d reversal) | Martingale | `2022-01-01` | 1180d from 2022-01-03 | +0.9% | 0.10 | -28.4% | -0.64 | trailed benchmark |
<!--SCOREBOARD:END-->
