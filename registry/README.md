...
<!--SCOREBOARD:START-->
_Last run **2026-07-23** · data source: **real SPY daily (Yahoo)** · cost: 1&nbsp;bp per turnover · benchmark: buy &amp; hold SPY._

| # | Strategy | Author | Locked | OOS window | OOS return | Sharpe | Max DD | vs B&H | Status |
|--:|---|---|:--:|:--:|--:|--:|--:|--:|:--|
| 1 | Buy & Hold | Martingale | `2022-01-01` | 1141d from 2022-01-03 | +64.2% | 0.71 | -24.5% | — | _benchmark_ |
| 2 | Time-Series Momentum (60d) | Martingale | `2022-01-01` | 1141d from 2022-01-03 | +14.9% | 0.26 | -27.5% | -0.45 | trailed benchmark |
| 3 | Mean Reversion (1d reversal) | Martingale | `2022-01-01` | 1141d from 2022-01-03 | +2.9% | 0.12 | -28.4% | -0.59 | trailed benchmark |
| 4 | SMA Crossover (20/100) | Martingale | `2022-01-01` | 1141d from 2022-01-03 | -1.0% | 0.08 | -32.9% | -0.64 | trailed benchmark |
<!--SCOREBOARD:END-->
