...
<!--SCOREBOARD:START-->
_Last run **2026-09-04** · data source: **real SPY daily (Yahoo)** · cost: 1&nbsp;bp per turnover · benchmark: buy &amp; hold SPY._

| # | Strategy | Author | Locked | OOS window | OOS return | Sharpe | Max DD | vs B&H | Status |
|--:|---|---|:--:|:--:|--:|--:|--:|--:|:--|
| 1 | Buy & Hold | Martingale | `2022-01-01` | 1172d from 2022-01-03 | +71.3% | 0.75 | -24.5% | — | _benchmark_ |
| 2 | Time-Series Momentum (60d) | Martingale | `2022-01-01` | 1172d from 2022-01-03 | +19.9% | 0.31 | -27.5% | -0.44 | trailed benchmark |
| 3 | SMA Crossover (20/100) | Martingale | `2022-01-01` | 1172d from 2022-01-03 | +3.3% | 0.13 | -32.9% | -0.62 | trailed benchmark |
| 4 | Mean Reversion (1d reversal) | Martingale | `2022-01-01` | 1172d from 2022-01-03 | +1.0% | 0.10 | -28.4% | -0.65 | trailed benchmark |
<!--SCOREBOARD:END-->
